const projects = [
  {
    ...
    description:" A music blog to share your stories and memories or simply to introduce others about your favorite artists. Built using Bootstrap, JavaScript, NodeJS (Express), MongoDB, and Heroku.",
  },
  {
    id: 2,
